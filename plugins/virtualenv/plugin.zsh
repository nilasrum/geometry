# Color definitions
DEFAULT_COLOR=${GEOMETRY_COLOR_PROMPT:-243}
...
GEOMETRY_VIRTUALENV_ENCLOSING_PREFIX=${GEOMETRY_VIRTUALENV_ENCLOSING_PREFIX:-"("}
GEOMETRY_VIRTUALENV_ENCLOSING_SUFFIX=${GEOMETRY_VIRTUALENV_ENCLOSING_SUFFIX:-")"}
...
geometry_prompt_virtualenv_render() {
    ...
    # Print to stdout
    echo "$GEOMETRY_VIRTUALENV_ENCLOSING_PREFIX${environment_str}$GEOMETRY_VIRTUALENV_ENCLOSING_SUFFIX"
